...
| 7.3 | Review first-pass renders before broad regeneration | User decision |
...
**7.3 Review first-pass renders before broad regeneration**:
- After the first successful character sheet and representative first-pass pages, summarize visible deviations in character consistency, panel readability, tone, pacing, and cover/page differentiation.
- Let the user decide whether to keep the pass, adjust prompts, or selectively regenerate pages.
- Prefer targeted prompt fixes and selective regeneration over rerunning the whole comic batch by reflex.
