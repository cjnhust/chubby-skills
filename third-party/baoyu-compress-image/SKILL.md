...
Treat these as this skill's direct defaults. If a larger workflow wants a one-off output format or quality for the current run, pass it explicitly instead of mutating persistent defaults.
