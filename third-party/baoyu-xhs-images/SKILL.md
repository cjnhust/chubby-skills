...
**Post-render review before broad regeneration**:
- After the first successful series pass or representative first-pass images, summarize visible deviations in style consistency, cover-to-content differentiation, readability, and overall XHS-native tone.
- Let the user decide whether to keep the pass, adjust prompts, or selectively regenerate images.
- Prefer targeted prompt fixes and selective regeneration over regenerating the whole series by reflex.
