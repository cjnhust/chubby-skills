...
This skill is a leaf capability in the content-transformation family. If translation is only one stage of a larger capture/format/export flow, prefer `baoyu-content-pipeline` as the entrypoint.
