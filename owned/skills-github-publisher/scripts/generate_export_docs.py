...
def build_codex_setup(root: Path) -> str:
    ...
    lines.append("- Trigger Codex review through exactly one supported GitHub flow for each head: repository auto review, reviewer request, or a manual `@codex review` fallback. Do not stack multiple trigger paths on the same head.")
