...
def build_codex_setup(root: Path) -> str:
    ...
    lines.append("- If a finding is already fixed on the latest head but the old review thread stays open, resolve that thread manually and rerun `@codex review` on the latest head.")
