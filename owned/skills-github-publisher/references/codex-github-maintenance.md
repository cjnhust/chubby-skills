...
- when a latest-head fix makes an older Codex finding obsolete but GitHub leaves the review thread open, manually resolve the thread and only request one fresh current-head review if the PR head changed or the latest review was dismissed
